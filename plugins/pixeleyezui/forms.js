...
const formsStyle = plugin(
    function ({ addComponents }) {
        ...
        addComponents({
            '.form-input': {
                '@apply border rounded-md block text-base h-10 py-3.5 px-6 w-full border-gray-200 bg-white focus:outline-0 focus:shadow-none focus:ring-0 focus:border-primary-500 placeholder:text-gray-400 disabled:text-gray-500 disabled:cursor-default disabled:bg-gray-100 disabled:border-gray-200': {},
                /*-----dark mode-----*/
