          ...
          <div className="container relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p
                ...
                data-sal-delay="200"
              >
                Get to know the visionary speakers who will lead our event with
                powerful ideas, industry insights, and practical knowledge.
                Learn about their backgrounds, session topics, and the
