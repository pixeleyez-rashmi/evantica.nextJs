...
import ContactBg from "../../../../assets/images/event/main-banner-bg.jpg";
...
export default function SpeakerDetailsHome() {
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              ...
              data-sal-delay="200"
            >
              View detailed information about each speaker, including their
              professional background, areas of expertise, and session
              schedules. This section helps you understand the knowledge each
              speaker brings to the event.
            </p>
            <div
