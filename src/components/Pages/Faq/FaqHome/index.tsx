...
import FaqBg from "../../../../assets/images/event/main-banner-bg.jpg";
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              ...
              data-sal-delay="200"
            >
              Choose the ticket that fits your experience and enjoy full access
              to sessions, networking, and event highlights. See our FAQ below
              for details on ticket types, upgrades, and policies.
            </p>
            <div
