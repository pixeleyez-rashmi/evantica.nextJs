...
import ourSponsorBg from "../../../../assets/images/event/main-banner-bg.jpg";
...
export default function OurSponsorHome() {
  ...
  return (
    <>
      <section
        ...
        style={{ backgroundImage: `url(${ourSponsorBg.src})` }}
      >
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              {" "}
              We are proud to be supported by our amazing sponsors who make this
              event possible. Their commitment, innovation, and partnership help
              us deliver an unforgettable experience. Explore the brands and
              organizations powering our event.
            </p>
            <div
