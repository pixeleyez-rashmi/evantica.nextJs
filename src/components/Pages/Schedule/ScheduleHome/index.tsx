...
import ScheduleBg from "../../../../assets/images/event/main-banner-bg.jpg";
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              ...
              data-sal-delay="200"
            >
              Explore our full event schedule to plan your day! From keynote
              sessions to breakout workshops, networking opportunities, and
              panel discussions, discover all the sessions and activities lined
              up for you.
            </p>
            <div
