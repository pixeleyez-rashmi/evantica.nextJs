...
export default function TicketPricingHome() {
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              ...
              data-sal-delay="200"
            >
              Choose the perfect ticket option that suits your experience. Our
              flexible pricing plans offer access to inspiring sessions,
              exclusive networking opportunities, and unforgettable moments
