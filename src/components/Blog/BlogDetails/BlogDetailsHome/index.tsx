...
import BlogDetailBg from "../../../../assets/images/event/main-banner-bg.jpg";
...
export default function BLogDetailsHome() {
  ...
  return (
    <>
      <section
        className="lg:py-70 py-40 lg:mx-7 mx-2 rounded-3xl bg-fixed bg-cover bg-center text-center text-white relative mt-5 md:mb-15 mb-10"
        style={{ backgroundImage: `url(${BlogDetailBg.src})` }}
      >
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              ...
              data-sal-delay="200"
            >
              Stay updated with our latest blog posts! Explore expert tips,
              industry insights, and articles on events, technology, and
              leadership. Discover valuable content to inspire, inform, and help
              you stay ahead professionally.
            </p>
            <div
