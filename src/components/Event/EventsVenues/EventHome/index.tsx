  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: `url(${VenueBg.src})` }}
      >
        ...
        <div className="container relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              ...
              data-sal-delay="200"
            >
              Discover the exact location of our upcoming event. Find detailed
              directions, nearby landmarks, and parking information to make your
              visit smooth and hassle-free. Join us at the venue and experience
              the event without any confusion.
            </p>
            <div
