        ...
        <div className="grid grid-cols-12 py-16 md:py-24 lg:pb-30 lg:pt-60 2xl:gap-10 gap-6">
          ...
          <div className="col-span-12 sm:col-span-6 xl:col-span-5 lg:col-span-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 mt-7 text-[18px]">
              Freelancer Creators Meetup is a community-driven event where designers, developers,
              marketers, and creators connect, collaborate, and grow through real conversations,
              talks, and networking sessions.
            </p>

            <div className="mt-15">
              <form onSubmit={handleSubmit} className="relative max-w-md flex flex-wrap md:flex-nowrap items-center md:gap-7 gap-2 border border-black/20 dark:border-white/30 rounded-xl md:p-1 md:ps-4 p-2">
                <input
                  type="email"
          ...
          <div className="col-span-12 sm:col-span-6 xl:col-span-3 lg:col-span-4">
            ...
            <ul className="space-y-4 text-gray-600 dark:text-gray-300">
              <li className="flex items-start gap-3 text-[18px]">
                ...
                <span>
                  Freelancer Creators Meetup,<br />
                  Creative Hub, Andheri East,<br />
                  Mumbai, India
                </span>
              </li>
              ...
              <li className="flex items-center gap-3 text-[18px]">
                ...
                <Link href="tel:+919876543210" className="hover:text-black dark:hover:text-white">
                  +91 [875] [648] [123]
                </Link>
              </li>
              ...
              <li className="flex items-center gap-3 text-[18px]">
                ...
                <Link href="mailto:meetup@freelancercreators.com" className="hover:text-black dark:hover:text-white">
                  meetup@gmail.com
                </Link>
              </li>
